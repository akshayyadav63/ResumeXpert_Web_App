...
export const TemplateCard = ({ thumbnailImg, isSelected, onSelect }) => {
  return (
    <div
      className={`group h-auto md:[height:300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer
    ...
    >
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-violet-100/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-100" />
        </div>
      ) : (
        <div className="w-full [height:200px] flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50">
