...
import { Check, Edit, Eye, EyeOff } from 'lucide-react'; // ✅ Import both

export default function Input({ value, onChange, label, placeholder, type = 'text' }) {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.inputContainer(isFocused)}>
        <input
          type={type === 'password' ? (showPassword ? 'text' : 'password') : 'text'} // ✅ Fixed
