...
function ThemeSelectors({ selectedTheme, setSelectedTheme, resumeData, onClose }) {
  const resumeRef = useRef(null);
  const [baseWidth, setBaseWidth] = useState(800);

  const handleThemeSelection = () => {
    setSelectedTheme(selectedTemplates.theme);
    onClose(); // ✅ Fixed casing
  };
